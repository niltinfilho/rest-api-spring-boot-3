...
import br.app.gestaotec.demo_park_api.service.ClienteVagaService;
import br.app.gestaotec.demo_park_api.service.EstacionamentoService;
import br.app.gestaotec.demo_park_api.service.JasperService;
...
public class EstacionamentoController {
    ...
    @Operation(summary = "Operação de check-out", description = "Recurso para dar saída de um veículo do estacionamento" +
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Número de recibo inexistente ou " +
    ...
    @Operation(summary = "Localizar os registros de estacionamentos do cliente por CPF", description = "Localizar os " +
            "registros de estacionamentos do cliente por CPF. Requisicao exige uso de um bearer token.",
            security = @SecurityRequirement(name = "security"),
            parameters = {
                    @Parameter(in = ParameterIn.PATH, name = "cpf", description = "N° do CPF referente ao cliente a ser consultado",
                            required = true
                    ),
